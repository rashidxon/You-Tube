...
import {Tag, FavoriteOutlined, MarkChatRead, Visibility, CheckCircle} from '@mui/icons-material'
...
const VideoDetail = () => {
  ...
  const [relatedVideo, setRelaredVideo] = useState([])
  ...
  useEffect(()=>{
    const getData = async() => {
      try {
        ...
        setRelaredVideo(relatedData.items)
      } catch (error) {
        console.log(error);
      }
    }
